<header
    class="sticky top-0 flex w-full bg-white border-gray-200 z-[30] dark:border-gray-800 dark:bg-gray-900 xl:border-b h-[72px]"
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <!-- Desktop: spacer supaya theme+notif ke kanan -->
            <div class="hidden xl:flex flex-1"></div>

            <!-- Desktop: Theme + Notification -->
