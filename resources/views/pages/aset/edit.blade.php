<x-modal id="editAsetModal" title="Edit Aset">
    ...
    <form id="editAsetForm" enctype="multipart/form-data" data-autosave-key="aset-edit-<?php echo e($aset->id); ?>">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi_aset" list="edit-lokasiOptions" value="{{ $aset->lokasi_aset }}"
                            placeholder="Ketik atau pilih lokasi" autocomplete="off"
                        ...
                        <datalist id="edit-lokasiOptions">
        ...
        <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
            ...
            @php $canEditAset = auth()->user()?->hasHakAkses('EDIT_ASET'); @endphp
            @if($canEditAset)
            <button type="button"
