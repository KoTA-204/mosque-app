...
<div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 px-6 py-4">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Hak Akses</h1>
        </div>
    </div>
    ...
    <div>
        <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
            ...
            <form method="POST" action="{{ route('dashboard.hak-akses.update', $hak_akses) }}" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="kode_hak_akses"
                        value="{{ old('kode_hak_akses', $hak_akses->kode_hak_akses) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nama_hak_akses"
                        value="{{ old('nama_hak_akses', $hak_akses->nama_hak_akses) }}"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="modul"
                            value="{{ old('modul', $hak_akses->modul) }}"
                            class="w-full px-4 py-2.5 text-sm border rounded-xl outline-none transition-colors
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="aksi"
                                ...
                                <option value="{{ $act }}" {{ old('aksi', $hak_akses->aksi) == $act ? 'selected' : '' }}>
                                    {{ ucfirst($act) }}
                                </option>
                                @endforeach
                            </select>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3"
                        ...
                        class="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-700 focus:border-blue-400 rounded-xl outline-none resize-none transition-colors
                            bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400">{{ old('deskripsi', $hak_akses->deskripsi) }}</textarea>
                </div>
                ...
                <div>
                    <label class="flex items-center gap-2.5 cursor-pointer w-fit">
                        <input type="checkbox" name="aktif" value="1"
                               {{ old('aktif', $hak_akses->aktif) ? 'checked' : '' }}
