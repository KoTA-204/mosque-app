...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="flex items-center justify-between bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 px-6 py-4 mb-6">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Detail Peran</h1>
        </div>
    </div>
        ...
        <div class="xl:col-span-1">
            <div class="rounded-xl border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="border-b border-stroke px-6 py-4 dark:border-strokedark">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-body dark:text-bodydark">{{ $peran->slug }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <dl class="space-y-4">
                        ...
                        <div>
                            ...
                            <dd class="flex items-center gap-2 text-sm font-medium text-black dark:text-white">
                                ...
                                {{ $peran->pengguna->count() ?? 0 }} Pengguna
                            </dd>
                        </div>
                        ...
                        <div>
                            ...
                            <dd class="flex items-center gap-2 text-sm font-medium text-black dark:text-white">
                                ...
                                {{ $peran->hak_akses->count() }} HakAkses
                            </dd>
                        </div>
                    </dl>
                </div>
                ...
                <div class="flex items-center gap-2 border-t border-stroke px-6 py-4 dark:border-strokedark">
                    <a href="{{ route('dashboard.peran.edit', $peran) }}"
                ...
                <div class="p-6">
                    @if($peran->hak_akses->isEmpty())
                        <div class="flex flex-col items-center justify-center py-10 text-center">
                            ...
                            <p class="text-sm font-medium text-black dark:text-white">Belum ada hak_akses</p>
                            <p class="mt-1 text-xs text-body dark:text-bodydark">
                                Edit peran untuk menambahkan hak_akses
                            </p>
                        </div>
                    @else
                        {{-- Group by module --}}
                        @php
                            $grouped = $peran->hak_akses->groupBy('modul');
                        @endphp
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @foreach($perms as $hak_akses)
                                        @php
                                            ...
                                            $color = $colorMap[$hak_akses->aksi ?? ''] ?? 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300';
                                        @endphp
