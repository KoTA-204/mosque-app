...
<div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 px-6 py-4">
        ...
        @can('permission:CREATE_JURNAL_UMUM')
            ...
            <div class="flex items-center gap-2 flex-wrap">
                ...
                <div class="relative">
                    <input type="month" id="filterBulan" value="{{ $bulan }}" onchange="applyFilters()"
                        class="text-sm border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1.5 pr-8 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 outline-none focus:border-green-400">
                </div>
                {{-- Search --}}
                <div class="relative">
