...
<div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 px-6 py-4">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Permission</h1>
        </div>
    </div>
    ...
    <div>
        <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
            ...
            <form method="POST" action="{{ route('dashboard.permissions.update', $permission) }}" class="space-y-5">
                @csrf
                @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="action"
                                ...
                                <option value="{{ $act }}" {{ old('action', $permission->action) == $act ? 'selected' : '' }}>
                                    {{ ucfirst($act) }}
                                </option>
                                @endforeach
                            </select>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        ...
                        class="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-700 focus:border-blue-400 rounded-xl outline-none resize-none transition-colors
                            bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400">{{ old('description', $permission->description) }}</textarea>
                </div>
