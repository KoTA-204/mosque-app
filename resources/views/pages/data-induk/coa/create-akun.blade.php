...
<form method="POST"
        ...
        class="space-y-5"
        onsubmit="return guardSubmit(this, {{ $canCreateCoa ? 'true' : 'false' }}, 'Anda tidak memiliki akses untuk menyimpan data akun.') && handleFormSubmit(this)">
    @csrf
    ...
    <div>
        ...
        <textarea name="deskripsi" rows="4" placeholder="Masukan deskripsi akun" 
