...
@section('content')
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <div class="border-b border-gray-200 px-6 py-5 dark:border-gray-800">
            <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Tambah Kegiatan Khusus</h4>
        </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <select name="jenis_kegiatan"
                                ...
                                <option value="QURBAN" {{ old('jenis_kegiatan') == 'QURBAN' ? 'selected' : '' }}>Qurban
                                </option>
                                <option value="ZAKAT" {{ old('jenis_kegiatan') == 'ZAKAT' ? 'selected' : '' }}>Zakat
                                </option>
                                <option value="KAJIAN" {{ old('jenis_kegiatan') == 'KAJIAN' ? 'selected' : '' }}>Kajian
                                </option>
                                <option value="SOSIAL" {{ old('jenis_kegiatan') == 'SOSIAL' ? 'selected' : '' }}>Sosial
                                </option>
                                <option value="LAINNYA" {{ old('jenis_kegiatan') == 'LAINNYA' ? 'selected' : '' }}>Lainnya
                                </option>
                            </select>
                        ...
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select name="status"
                                    ...
                                    <option value="BERJALAN" {{ old('status') == 'BERJALAN' ? 'selected' : '' }}>Berjalan
                                    </option>
