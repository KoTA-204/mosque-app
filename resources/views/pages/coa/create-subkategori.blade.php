{{-- dashboard/chart-of-account/create-sub-kategori.blade.php --}}
@extends('layouts.app')

@section('title', 'Tambah Sub Kategori Akun')
...
<div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 px-6 py-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Tambah Sub Kategori Akun</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-2xl">
        <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-6">Tambah Sub Kategori Akun</h2>

            <form method="POST" action="{{ route('dashboard.coa.sub-kategori.store') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        <select name="kategori_akun_id"
                            ...
                            <option value="{{ $kat->id }}" {{ old('kategori_akun_id') == $kat->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="4"
                        placeholder="Masukan deskripsi sub kategori"
