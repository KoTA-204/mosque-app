...
<form method="POST"
    ...
    <div>
        ...
        <input type="text" name="kode_kategori" value="{{ old('kode_kategori') }}" placeholder="Contoh: 1, 2, 3" class="w-full px-4 py-2.5 text-sm border rounded-xl outline-none transition-colors
    ...
    <div class="flex items-center gap-3 pt-2">
        <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white text-sm font-semibold px-6 py-2.5 rounded-xl transition-colors">Simpa</button>
    </div>
