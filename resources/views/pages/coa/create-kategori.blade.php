...
<div class="p-6 space-y-6">
    ...
    <div class="max-w-2xl">
        <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
            ...
            <form method="POST" action="{{ route('dashboard.coa.kategori.store') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="kode_kategori" value="{{ old('kode_kategori') }}"
                        ...
                        class="w-full px-4 py-2.5 text-sm border rounded-xl outline-none transition-colors
                            {{ $errors->has('kode_kategori') ? 'border-red-400 focus:border-red-400' : 'border-gray-200 dark:border-gray-700 focus:border-green-400' }}
                ...
                <div>
                    ...
                    <input type="text" name="nama_kategori" value="{{ old('nama_kategori') }}"
                        placeholder="Masukan nama kategori akun"
                        class="w-full px-4 py-2.5 text-sm border rounded-xl outline-none transition-colors
