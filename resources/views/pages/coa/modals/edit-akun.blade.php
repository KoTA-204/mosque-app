...
<div class="p-6">
    ...
    <form method="POST" action="{{ route('dashboard.coa.akun.update', $akun->id) }}" class="space-y-5">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="kode_akun" value="{{ old('kode_akun', $akun->kode_akun) }}" class="w-full px-4 py-2.5 text-sm border rounded-xl outline-none transition-colors
            ...
            <div>
                ...
                <input type="text" name="nama_akun" value="{{ old('nama_akun', $akun->nama_akun) }}" class="w-full px-4 py-2.5 text-sm border rounded-xl outline-none transition-colors
