{{-- dashboard/chart-of-account/create-akun.blade.php --}}
@extends('layouts.app')
    ...
    <div class="flex items-center justify-between bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 px-6 py-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Tambah Akun</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-2xl">
        <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
            ...
            <form method="POST" action="{{ route('dashboard.coa.akun.store') }}" class="space-y-5">
                ...
                {{-- Row: Sub Kategori + Status (Saldo Normal) --}}
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
