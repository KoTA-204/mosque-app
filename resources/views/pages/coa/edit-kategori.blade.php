...
<form method="POST" 
    ...
    <div>
        ...
        <input type="text" name="kode_kategori" value="{{ old('kode_kategori', $kat->kode_kategori) }}" class="w-full px-4 py-2.5 text-sm border rounded-xl outline-none transition-colors  
    ...
    <div>
        ...
        <input type="text" name="nama_kategori" value="{{ old('nama_kategori', $kat->nama_kategori) }}" class="w-full px-4 py-2.5 text-sm border rounded-xl outline-none transition-colors
            {{ $errors->has('kode_kategori')
                ? 'border-red-400 focus:border-red-400'
                : 'border-gray-200 dark:border-gray-700 focus:border-green-400'
            }}
