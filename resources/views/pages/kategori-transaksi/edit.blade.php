...
<div id="editKategoriModal{{ $item->id }}"
    ...
    <div class="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-2xl border border-gray-200 dark:border-gray-800">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-800">
            ...
            <button onclick="closeModal('editKategoriModal{{ $item->id }}')"
                class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                ✕
            </button>
        </div>

        <form method="POST" action="{{ route('dashboard.kategori-transaksi.update', $item) }}" class="p-6 space-y-5">
        @csrf
        @method('PUT')
